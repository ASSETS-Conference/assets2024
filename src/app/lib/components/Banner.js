...
export default function Banner({ heading, subheading, altBg }) {
  return (
    <div
      className={`h-[45vh] w-full relative overflow-hidden ${
        altBg ? "bg-hero-img-2" : "bg-hero-img"
      } bg-top bg-cover text-theme-off-white`}
    >
