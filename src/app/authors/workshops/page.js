        ...
        accessibility, please consider organizing a workshop.`}
          ...
          final accessible PDF.`}
            ...
            <Section title={"Workshop Format"} spacing={"none"}>
                <p>
                    {`Workshops will be online no earlier than the week of October 22 and in
          person on October 26, based on availability.`}
                </p>
                <p>
          ...
          get together and discuss.`}
            ...
            <Section
                title={`Workshop Selection Process`}
                spacing={"bottom-only"}
            >
                <p>
          ...
          workshop day:`}
            ...
            the ASSETS’24 web page.`}
                    ...
                    <li>
                        <strong>
                            Collect position papers or workshop artifacts:
                        </strong>
                        {` From potential
