    ...
    return (
        ...
        >
            <Section title="Important Dates" spacing={"bottom-only"}>
                <p>
                    <strong>All deadlines</strong> are 11:59 P.M. Anywhere on
                    Earth (UTC -12:00).
                </p>
            ...
            <Section title={"Submission Guidelines"} spacing={"bottom-only"}>
                ...
                <ul>
                    <li>
                        ...
                        to generate final multi-format representations of
                        accepted papers.
                    </li>
                    <li>
                        ...
                        (using “manuscript” style available in the template).
                ...
                <p>
                    It is expected that papers will be made accessible at the
                    time of review and for the final submission.{" "}
                    <b>
                        Paper submissions that are not accessible will be desk
                        rejected.
                    </b>{" "}
                    If you have questions about making your paper accessible,
                    please contact{" "}
                ...
                <h3 id="optional-accessible-video-figures">
                    Optional Accessible Video Figures as Supplementary Material
                </h3>
                <p>
                    You may include optional video figures to accompany your
                    paper submissions as supplementary material, which may be up
                    to <b>five minutes</b> long. There is a separate upload
                    field in the PrecisionConference website. Video figures are
                    strongly encouraged for papers introducing a novel system or
                    interaction technique. Video figures are not the same as
                    video presentations of accepted papers that are shown during
                    the conference.
                </p>
                <p>
          ...
          Papers, in which the`}{" "}
                    <b>
                        authors must anonymize their paper submissions, all
                        supplemental materials, and video figures.
                    </b>{" "}
                    {` We will follow the
          ...
          peer-reviewed by an international panel. `}
                    <Link href="https://new.precisionconference.com/user/login">
          ...
          date.`}
                ...
                <p>
                    ...
                    <b>
                        Wednesday, April 24th, 2024, 11:59 P.M. Anywhere on
                        Earth {`(UTC -12:00).`}
                    </b>{" "}
                ...
                <h2 id="author-PCS-account-details">
          ...
          contact email in PCS then this email will appear on your paper. Please check your author information and make the necessary changes. `}
                    <Link href="https://new.precisionconference.com/user/login">
                        ASSETS 2024 submission site
                    </Link>
                    {"."}
                </p>
                <h2 id="publishing-with-ACM-Digital-Library">
